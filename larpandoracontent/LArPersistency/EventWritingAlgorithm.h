 ...
 */
  ...
  private:
    ...
    bool
      m_shouldWriteMCRelationships; ///< Whether to write mc relationship information to the events file
    bool
      m_shouldWriteTrackRelationships; ///< Whether to write track relationship information to the events file

    bool
      m_shouldOverwriteEventFile; ///< Whether to overwrite existing event file with specified name, or append
    bool
      m_shouldOverwriteGeometryFile; ///< Whether to overwrite existing geometry file with specified name, or append
    ...
    bool
      m_useLArMCParticles; ///< Whether to write lar mc particles, or standard pandora mc particles
    ...
    bool
      m_neutrinoInducedOnly; ///< Whether to consider only mc particles that were neutrino induced
    unsigned int
      m_matchingMinPrimaryHits;   ///< The minimum number of mc primary hits used in matching scheme
    ...
    bool
      m_shouldFilterByNeutrinoVertex; ///< Whether to filter output by neutrino vertex position (e.g. fiducial volume cut)
