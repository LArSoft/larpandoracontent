 ...
 */
  ...
  private:
    ...
    public:
      /**
         ...
         */
      LArTransverseCluster(const pandora::Cluster* const pSeedCluster,
     ...
     */
    void GetNearbyClusterMap(const pandora::ClusterVector& allClusters,
     ...
     */
    void SortInputClusters(const pandora::ClusterVector& inputClusters,
     ...
     */
    void FillReducedAssociationMap(const ClusterToClustersMap& nearbyClusters,
     ...
     */
    void FillAssociationMap(const ClusterToClustersMap& nearbyClusters,
                            const pandora::ClusterVector& firstVector,
                            const pandora::ClusterVector& secondVector,
     ...
     */
    void FillTransverseClusterList(const ClusterToClustersMap& nearbyClusters,
     ...
     *  @param  clusterAssociationMap the output map of associations between clusters
     */
    void FillTransverseAssociationMap(const ClusterToClustersMap& nearbyClusters,
     ...
     */
    void GetAssociatedClusters(const ClusterToClustersMap& nearbyClusters,
     ...
     *  @return boolean
     */
    bool IsAssociated(const bool isForward,
     ...
     *  @return boolean
     */
    bool IsTransverseAssociated(const pandora::Cluster* const pCluster1,
                                const pandora::Cluster* const pCluster2,
                                const ClusterToClustersMap& nearbyClusters) const;
     ...
     *  @return boolean
     */
    bool IsTransverseAssociated(const LArTransverseCluster* const pTransverseCluster,
                                const pandora::CartesianVector& testPosition) const;
     ...
     *  @return boolean
     */
    bool IsOverlapping(const pandora::Cluster* const pCluster1,
     ...
     */
    float GetTransverseSpan(const pandora::Cluster* const pCluster,
                            const pandora::ClusterVector& associatedClusters) const;
     ...
     */
    void GetExtremalCoordinatesX(const pandora::Cluster* const pCluster,
                                 float& minX,
                                 float& maxX) const;
     ...
     */
    void GetExtremalCoordinatesZ(const pandora::Cluster* const pCluster,
                                 float& minZ,
                                 float& maxZ) const;
     ...
     */
    void GetExtremalCoordinatesXZ(const pandora::Cluster* const pCluster,
                                  const bool useX,
                                  float& minXZ,
                                  float& maxXZ) const;
     ...
     */
    void FillReducedAssociationMap(const ClusterAssociationMap& inputAssociationMap,
     ...
     */
    void FillReducedAssociationMap(const ClusterAssociationMap& firstAssociationMap,
     ...
     *  @param outputAssociationMap the outputted association map
     */
    void FillSymmetricAssociationMap(const ClusterAssociationMap& inputAssociationMap,
                                     ClusterAssociationMap& outputAssociationMap) const;
     ...
     *  @param outputAssociationMap the outputted association map
     */
    void FinalizeClusterAssociationMap(const ClusterAssociationMap& inputAssociationMap,
                                       ClusterAssociationMap& outputAssociationMap) const;
  ...
  TransverseAssociationAlgorithm::LArTransverseCluster::GetSeedCluster() const
  {
  ...
  inline const pandora::ClusterVector&
  TransverseAssociationAlgorithm::LArTransverseCluster::GetAssociatedClusters() const
  {
  ...
  TransverseAssociationAlgorithm::LArTransverseCluster::GetInnerVertex() const
  {
  ...
  inline const pandora::CartesianVector&
  TransverseAssociationAlgorithm::LArTransverseCluster::GetOuterVertex() const
  {
  ...
  inline const pandora::CartesianVector&
  TransverseAssociationAlgorithm::LArTransverseCluster::GetDirection() const
  {
    return m_direction;
  }
