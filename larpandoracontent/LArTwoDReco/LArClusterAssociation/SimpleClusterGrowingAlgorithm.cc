...
namespace lar_content {
  ...
  void SimpleClusterGrowingAlgorithm::GetListOfCleanClusters(const ClusterList* const pClusterList,
  ...
  void SimpleClusterGrowingAlgorithm::GetListOfSeedClusters(const ClusterVector& inputClusters,
