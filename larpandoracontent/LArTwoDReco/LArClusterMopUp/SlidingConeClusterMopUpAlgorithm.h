 ...
 */
  ...
  private:
     ...
     */
    void MakeClusterMerges(const ClusterToPfoMap& clusterToPfoMap,
    ...
    unsigned int
      m_maxHitsToConsider2DCluster; ///< The maximum number of hits in a 2d cluster to allow pick-up via sliding cone fits
    ...
    float
      m_coneTanHalfAngle; ///< The cone tan half angle to use when calculating bounded cluster fractions
  ...
  inline const pandora::Cluster* SlidingConeClusterMopUpAlgorithm::ClusterMerge::GetParentCluster()
    const
  {
