 ...
 */
  ...
  private:
    ...
    public:
      /**
         ...
         */
      HitAssociation(const pandora::CaloHit* const pPrimaryTarget,
      ...
      /**
         ...
         */
      void SetSecondaryTarget(const pandora::CaloHit* const pSecondaryTarget,
     ...
     */
    pandora::StatusCode FilterCaloHits(const pandora::CaloHitList* const pCaloHitList,
     ...
     */
    void MakePrimaryAssociations(const pandora::OrderedCaloHitList& orderedCaloHitList,
     ...
     *  @param  backwardHitAssociationMap the backward hit association map
     */
    void MakeSecondaryAssociations(const pandora::OrderedCaloHitList& orderedCaloHitList,
                                   HitAssociationMap& forwardHitAssociationMap,
                                   HitAssociationMap& backwardHitAssociationMap) const;
     ...
     */
    void IdentifyJoins(const pandora::OrderedCaloHitList& orderedCaloHitList,
     ...
     *  @param  hitToClusterMap the mapping between hits and their clusters
     */
    void CreateClusters(const pandora::OrderedCaloHitList& orderedCaloHitList,
     ...
     *  @param  backwardHitAssociationMap the backward hit association map
     */
    void CreatePrimaryAssociation(const pandora::CaloHit* const pCaloHitI,
     ...
     *  @param  backwardHitAssociationMap the backward hit association map
     */
    void CreateSecondaryAssociation(const pandora::CaloHit* const pCaloHitI,
                                    const pandora::CaloHit* const pCaloHitJ,
                                    HitAssociationMap& forwardHitAssociationMap,
                                    HitAssociationMap& backwardHitAssociationMap) const;
     ...
     */
    const pandora::CaloHit* GetJoinHit(const pandora::CaloHit* const pCaloHit,
     ...
     */
    const pandora::CaloHit* TraceHitAssociation(const pandora::CaloHit* const pCaloHit,
                                                const HitAssociationMap& hitAssociationMapI,
  ...
  inline TrackClusterCreationAlgorithm::HitAssociation::HitAssociation(
    const pandora::CaloHit* const pPrimaryTarget,
    const float primaryDistanceSquared)
  ...
  inline void TrackClusterCreationAlgorithm::HitAssociation::SetSecondaryTarget(
    const pandora::CaloHit* const pSecondaryTarget,
    const float secondaryDistanceSquared)
  {
  ...
  inline const pandora::CaloHit* TrackClusterCreationAlgorithm::HitAssociation::GetPrimaryTarget()
    const
  {
  ...
  inline const pandora::CaloHit* TrackClusterCreationAlgorithm::HitAssociation::GetSecondaryTarget()
    const
  {
