...
namespace lar_content {
  ...
  TwoDParticleCreationAlgorithm::TwoDParticleCreationAlgorithm()
    : m_minHitsInCluster(5), m_minClusterEnergy(0.f)
  {}
  ...
  StatusCode TwoDParticleCreationAlgorithm::Run()
  {
    ...
    if (!m_inputClusterListNameU.empty()) {
      ...
      PANDORA_RETURN_RESULT_IF(
        STATUS_CODE_SUCCESS,
        !=,
        PandoraContentApi::GetList(*this, m_inputClusterListNameU, pClusterListU));
    ...
    if (!m_inputClusterListNameV.empty()) {
      ...
      PANDORA_RETURN_RESULT_IF(
        STATUS_CODE_SUCCESS,
        !=,
        PandoraContentApi::GetList(*this, m_inputClusterListNameV, pClusterListV));
    ...
    if (!m_inputClusterListNameW.empty()) {
      ...
      PANDORA_RETURN_RESULT_IF(
        STATUS_CODE_SUCCESS,
        !=,
        PandoraContentApi::GetList(*this, m_inputClusterListNameW, pClusterListW));
  ...
  StatusCode TwoDParticleCreationAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
  {
    ...
    PANDORA_RETURN_RESULT_IF_AND_IF(
      ...
      !=,
      XmlHelper::ReadValue(xmlHandle, "ClusterListNameU", m_inputClusterListNameU));

    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
      !=,
      XmlHelper::ReadValue(xmlHandle, "ClusterListNameV", m_inputClusterListNameV));

    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
      !=,
      XmlHelper::ReadValue(xmlHandle, "ClusterListNameW", m_inputClusterListNameW));
    ...
    PANDORA_RETURN_RESULT_IF_AND_IF(
      ...
      STATUS_CODE_NOT_FOUND,
      !=,
      XmlHelper::ReadValue(xmlHandle, "MinClusterEnergy", m_minClusterEnergy));
