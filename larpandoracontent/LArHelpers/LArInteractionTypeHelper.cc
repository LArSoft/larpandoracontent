...
namespace lar_content {
  ...
  LArInteractionTypeHelper::InteractionType LArInteractionTypeHelper::GetInteractionType(
    const MCParticleList& mcPrimaryList)
  {
    if (mcPrimaryList.empty()) throw StatusCodeException(STATUS_CODE_NOT_INITIALIZED);

    InteractionParameters parameters;
    LArInteractionTypeHelper::SetInteractionParameters(mcPrimaryList, parameters);

    const InteractionType cosmicRayHypothesis(
      LArInteractionTypeHelper::CosmicRayHypothesis(mcPrimaryList, parameters));

    if (OTHER_INTERACTION != cosmicRayHypothesis) return cosmicRayHypothesis;
    ...
    if (!pMCNeutrino) throw StatusCodeException(STATUS_CODE_FAILURE);
    ...
    if (1001 == nuNuanceCode) {
      if ((1 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (0 == parameters.m_nProtons))
        return CCQEL_MU;
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (1 == parameters.m_nProtons))
        return CCQEL_MU_P;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (2 == parameters.m_nProtons))
        return CCQEL_MU_P_P;
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (3 == parameters.m_nProtons))
        return CCQEL_MU_P_P_P;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (4 == parameters.m_nProtons))
        return CCQEL_MU_P_P_P_P;
      if ((6 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (5 == parameters.m_nProtons))
        return CCQEL_MU_P_P_P_P_P;

      if ((1 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (0 == parameters.m_nProtons))
        return CCQEL_E;
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (1 == parameters.m_nProtons))
        return CCQEL_E_P;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (2 == parameters.m_nProtons))
        return CCQEL_E_P_P;
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (3 == parameters.m_nProtons))
        return CCQEL_E_P_P_P;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (4 == parameters.m_nProtons))
        return CCQEL_E_P_P_P_P;
      if ((6 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (5 == parameters.m_nProtons))
    ...
    if ((nuNuanceCode >= 1003) && (nuNuanceCode <= 1005)) {
      ...
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (0 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_PIPLUS;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (1 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_P_PIPLUS;
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (2 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_P_P_PIPLUS;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (3 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_P_P_P_PIPLUS;
      if ((6 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (4 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_P_P_P_P_PIPLUS;
      if ((7 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (5 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
        return CCRES_MU_P_P_P_P_P_PIPLUS;

      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (0 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_PHOTON;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (1 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_P_PHOTON;
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (2 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_P_P_PHOTON;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (3 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_P_P_P_PHOTON;
      if ((6 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (4 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_P_P_P_P_PHOTON;
      if ((7 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (5 == parameters.m_nProtons) && (1 == parameters.m_nPhotons))
        return CCRES_MU_P_P_P_P_P_PHOTON;

      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (0 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
        return CCRES_MU_PIZERO;
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (1 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
        return CCRES_MU_P_PIZERO;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (2 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
        return CCRES_MU_P_P_PIZERO;
      if ((6 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (3 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
        return CCRES_MU_P_P_P_PIZERO;
      if ((7 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (4 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
        return CCRES_MU_P_P_P_P_PIZERO;
      if ((8 == parameters.m_nNonNeutrons) && (1 == parameters.m_nMuons) &&
          (5 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
      ...
      if ((7 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (5 == parameters.m_nProtons) && (1 == parameters.m_nPiPlus))
      ...
      if ((8 == parameters.m_nNonNeutrons) && (1 == parameters.m_nElectrons) &&
          (5 == parameters.m_nProtons) && (2 == parameters.m_nPhotons))
    ...
    if ((nuNuanceCode >= 1006) && (nuNuanceCode <= 1009)) {
      ...
      if ((1 == parameters.m_nNonNeutrons) && (0 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_PIPLUS;
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_P_PIPLUS;
      if ((3 == parameters.m_nNonNeutrons) && (2 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_P_P_PIPLUS;
      if ((4 == parameters.m_nNonNeutrons) && (3 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_P_P_P_PIPLUS;
      if ((5 == parameters.m_nNonNeutrons) && (4 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_P_P_P_P_PIPLUS;
      if ((6 == parameters.m_nNonNeutrons) && (5 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiPlus))
        return NCRES_P_P_P_P_P_PIPLUS;

      if ((1 == parameters.m_nNonNeutrons) && (0 == parameters.m_nProtons) &&
          (1 == parameters.m_nPiMinus))
      ...
      if ((2 == parameters.m_nNonNeutrons) && (0 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
        return NCRES_PIZERO;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
        return NCRES_P_PIZERO;
      if ((4 == parameters.m_nNonNeutrons) && (2 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
        return NCRES_P_P_PIZERO;
      if ((5 == parameters.m_nNonNeutrons) && (3 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
        return NCRES_P_P_P_PIZERO;
      if ((6 == parameters.m_nNonNeutrons) && (4 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
        return NCRES_P_P_P_P_PIZERO;
      if ((7 == parameters.m_nNonNeutrons) && (5 == parameters.m_nProtons) &&
          (2 == parameters.m_nPhotons))
  ...
  LArInteractionTypeHelper::InteractionType
  LArInteractionTypeHelper::GetTestBeamHierarchyInteractionType(const MCParticleList& mcPrimaryList)
  {
    if (mcPrimaryList.empty()) throw StatusCodeException(STATUS_CODE_NOT_INITIALIZED);
    ...
    for (const MCParticle* const pMCPrimary : mcPrimaryList) {
      if (LArMCParticleHelper::GetParentMCParticle(pMCPrimary) != pMCPrimary) continue;
    ...
    for (const MCParticle* const pMCPrimary : mcPrimaryList) {
      ...
      else if ((111 == pMCPrimary->GetParticleId() ||
                211 == std::fabs(pMCPrimary->GetParticleId())) &&
               pMCPrimary->GetParentList().size() == 1) {
        const MCParticle* const pParentMCParticle(pMCPrimary->GetParentList().front());
    ...
    if (211 == targetParentId) {
      ...
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nPiPlus) &&
          (1 == parameters.m_nPhotons))
        return BEAM_PARTICLE_PI_PLUS_PI_PLUS_PHOTON;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nPiPlus) &&
          (1 == parameters.m_nPiZero))
      ...
      if ((2 == parameters.m_nNonNeutrons) && (1 == parameters.m_nPiMinus) &&
          (1 == parameters.m_nPhotons))
        return BEAM_PARTICLE_PI_MINUS_PI_MINUS_PHOTON;
      if ((3 == parameters.m_nNonNeutrons) && (1 == parameters.m_nPiMinus) &&
          (1 == parameters.m_nPiZero))
      ...
      if ((4 == parameters.m_nNonNeutrons) && (1 == parameters.m_nProtons) &&
          (3 == parameters.m_nPhotons))
        return BEAM_PARTICLE_P_P_PHOTON_PHOTON_PHOTON;
      if ((5 == parameters.m_nNonNeutrons) && (1 == parameters.m_nProtons) &&
          (4 == parameters.m_nPhotons))
      ...
      if ((5 == parameters.m_nNonNeutrons) && (2 == parameters.m_nProtons) &&
          (3 == parameters.m_nPhotons))
      ...
      if ((parameters.m_nNonNeutrons >= 2) && (1 == parameters.m_nKaonPlus) &&
          (1 == parameters.m_nKaon0L))
      ...
      if ((parameters.m_nNonNeutrons >= 2) && (1 == parameters.m_nKaonMinus) &&
          (1 == parameters.m_nKaon0L))
  ...
  void LArInteractionTypeHelper::SetInteractionParameters(const MCParticleList& mcPrimaryList,
                                                          InteractionParameters& parameters)
  {
    for (const MCParticle* const pMCPrimary : mcPrimaryList) {
