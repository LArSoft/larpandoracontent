 ...
 */
  ...
  public:
     ...
     */
    static unsigned int CountHitsByType(const pandora::HitType hitType,
     ...
     */
    static void GetOrderedMCParticleVector(
     ...
     */
    static void GetOrderedPfoVector(
     ...
     */
    static void PrintMCParticleTable(
      const LArMCParticleHelper::MCContributionMap& selectedMCParticleToGoodHitsMaps,
     ...
     */
    static void PrintMatchingTable(
      const pandora::PfoVector& orderedPfoVector,
      const pandora::MCParticleVector& orderedMCParticleVector,
