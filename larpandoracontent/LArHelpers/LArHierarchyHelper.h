 ...
 */
  ...
  public:
    ...
    public:
      ...
      bool
        m_foldToLeadingShowers; ///< Whether or not to fold shower children to the leading shower particle
      bool m_foldToTier;        ///< Whether or not to apply folding based on particle tier
      bool
        m_foldDynamic; ///< Whether or not to use process and topological information to make folding decisions
      float
        m_cosAngleTolerance; ///< Cosine of the maximum angle at which topologies can be considered continuous
    ...
    public:
      ...
      public:
        ...
        /**
             ...
             */
        ReconstructabilityCriteria(const unsigned int minHits,
      ...
      public:
        ...
        /**
             ...
             */
        void FillHierarchy(const pandora::MCParticle* pRoot,
      ...
      private:
        ...
        pandora::MCParticleList
          m_mcParticles; ///< The list of MC particles of which this node is composed
      ...
      /**
         ...
         */
      void FillHierarchy(const pandora::MCParticleList& mcParticleList,
                         const pandora::CaloHitList& caloHitList,
                         const FoldingParameters& foldParameters);
      ...
      /**
         ...
         */
      void InterpretHierarchy(const pandora::MCParticle* const pRoot,
    ...
    private:
      /**
         ...
         *  @param  cosAngleTolerance The cosine of the maximum angle for which trajectories are considered continuous
         */
      void CollectContinuations(const pandora::MCParticle* pRoot,
      ...
      ReconstructabilityCriteria
        m_recoCriteria; ///< The criteria used to determine if the node is reconstructable
      const pandora::MCParticle* m_pNeutrino; ///< The incident neutrino, if it exists
      std::map<const pandora::MCParticle*, pandora::CaloHitList>
        m_mcToHitsMap;                          ///< The map between MC particles and calo hits
    ...
    public:
      ...
      public:
        ...
        /**
             ...
             */
        Node(const RecoHierarchy& hierarchy,
        ...
        /**
             ...
             *  @param  foldParameters The folding parameters
             */
        void FillHierarchy(const pandora::ParticleFlowObject* pRoot,
                           const FoldingParameters& foldParameters);
    ...
    public:
      ...
      /**
         ...
         *  @return The purity of the match
         */
      float GetPurity(const RecoHierarchy::Node* pReco,
                      const pandora::HitType view,
                      const bool adcWeighted = false) const;
      ...
      /**
         ...
         *  @return The completeness of the match
         */
      float GetCompleteness(const RecoHierarchy::Node* pReco,
                            const pandora::HitType view,
                            const bool adcWeighted = false) const;
    ...
    private:
      /**
         ...
         *  @return The purity of the match
         */
      float GetPurity(const pandora::CaloHitVector& intersection,
      ...
      /**
         ...
         *  @return The completeness of the match
         */
      float GetCompleteness(const pandora::CaloHitVector& intersection,
    ...
    private:
      ...
      MCMatchesVector
        m_goodMatches; ///< The vector of good matches - above threshold one reco to one MC matches
      MCMatchesVector
        m_aboveThresholdMatches; ///< The vector of matches that pass quality but with multiple reco matches to the MC
     ...
     */
    static void FillMCHierarchy(const pandora::MCParticleList& mcParticleList,
                                const pandora::CaloHitList& caloHitList,
                                const FoldingParameters& foldParameters,
     ...
     */
    static void FillRecoHierarchy(const pandora::PfoList& pfoList,
                                  const FoldingParameters& foldParameters,
     ...
     */
    static void MatchHierarchies(const MCHierarchy& mcHierarchy,
  ...
  private:
     ...
     */
    static const pandora::MCParticle* GetMCPrimaries(const pandora::MCParticleList& mcParticleList,
     ...
     *  @return The root neutrino, if it exists, or nullptr
     */
    static const pandora::ParticleFlowObject* GetRecoPrimaries(const pandora::PfoList& pfoList,
                                                               PfoSet& primaries);
  };
  ...
  inline const LArHierarchyHelper::MCHierarchy::NodeVector&
  LArHierarchyHelper::MCHierarchy::Node::GetChildren() const
  {
    return m_children;
  }
  ...
  inline const pandora::MCParticleList& LArHierarchyHelper::MCHierarchy::Node::GetMCParticles()
    const
  {
  ...
  inline const pandora::MCParticle* LArHierarchyHelper::MCHierarchy::Node::GetLeadingMCParticle()
    const
  {
  ...
  inline int LArHierarchyHelper::MCHierarchy::Node::GetParticleId() const { return m_pdg; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline int LArHierarchyHelper::MCHierarchy::Node::GetHierarchyTier() const { return m_tier; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline bool LArHierarchyHelper::MCHierarchy::Node::IsNeutrinoInduced() const
  {
    return !(LArHierarchyHelper::MCHierarchy::Node::IsTestBeamParticle() ||
             LArHierarchyHelper::MCHierarchy::Node::IsCosmicRay());
  }
  ...
  inline const LArHierarchyHelper::MCHierarchy::NodeVector&
  LArHierarchyHelper::MCHierarchy::GetRootNodes() const
  {
    return m_rootNodes;
  }
  ...
  inline const LArHierarchyHelper::RecoHierarchy::NodeVector&
  LArHierarchyHelper::RecoHierarchy::Node::GetChildren() const
  {
    return m_children;
  }
  ...
  inline const LArHierarchyHelper::RecoHierarchy::NodeVector&
  LArHierarchyHelper::RecoHierarchy::GetRootNodes() const
  {
    return m_rootNodes;
  }
  ...
  inline const LArHierarchyHelper::RecoHierarchy::NodeVector&
  LArHierarchyHelper::MCMatches::GetRecoMatches() const
  {
    return m_recoNodes;
  }
  ...
  inline const LArHierarchyHelper::MCMatchesVector& LArHierarchyHelper::MatchInfo::GetMatches()
    const
  {
    return m_matches;
  }
  ...
  inline const LArHierarchyHelper::RecoHierarchy::NodeVector&
  LArHierarchyHelper::MatchInfo::GetUnmatchedReco() const
  {
  ...
  inline const LArHierarchyHelper::QualityCuts& LArHierarchyHelper::MatchInfo::GetQualityCuts()
    const
  {
