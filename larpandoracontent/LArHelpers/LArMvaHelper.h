 ...
 */
  ...
  public:
    ...
    virtual void Run(MvaTypes::MvaFeatureMap& featureMap,
 ...
 */
  ...
  public:
    ...
    typedef std::map<std::string, pandora::AlgorithmTool*>
      AlgorithmToolMap; // idea would be to put this in PandoraInternal.h at some point in PandoraSDK
    ...
    static pandora::StatusCode ProduceTrainingExample(const std::string& trainingOutputFile,
                                                      const bool result,
     ...
     */
    template <typename TCONTAINER>
    static bool Classify(const MvaInterface& classifier,
                         const pandora::StringVector& featureOrder,
                         TCONTAINER&& featureContainer);
     ...
     */
    template <typename TCONTAINER>
    static double CalculateClassificationScore(const MvaInterface& classifier,
                                               TCONTAINER&& featureContainer);
     ...
     */
    template <typename TCONTAINER>
    static double CalculateProbability(const MvaInterface& classifier,
                                       TCONTAINER&& featureContainer);
    ...
    static MvaFeatureVector CalculateFeatures(const MvaFeatureToolVector<Ts...>& featureToolVector,
                                              TARGS&&... args);
     ...
     */
    template <typename... Ts, typename... TARGS>
    static MvaFeatureMap CalculateFeatures(const pandora::StringVector& featureToolOrder,
    ...
    static MvaFeatureVector CalculateFeaturesOfType(
      const MvaFeatureToolVector<Ts...>& featureToolVector,
      TARGS&&... args);
     ...
     */
    template <typename... Ts>
    static pandora::StatusCode AddFeatureToolToVector(
      pandora::AlgorithmTool* const pFeatureTool,
     ...
     */
    template <typename... Ts>
    static pandora::StatusCode AddFeatureToolToMap(pandora::AlgorithmTool* const pFeatureTool,
     ...
     */
    static pandora::StatusCode ProcessAlgorithmToolListToMap(
  ...
  private:
     ...
     */
    template <typename TCONTAINER>
    static pandora::StatusCode WriteFeaturesToFile(std::ofstream& outfile,
     ...
     */
    template <typename TCONTAINER>
    static pandora::StatusCode WriteFeaturesToFileImpl(std::ofstream& outfile,
                                                       const std::string& delimiter,
                                                       TCONTAINER&& featureContainer);
  };
  ...
  template <typename TCONTAINER>
  pandora::StatusCode LArMvaHelper::ProduceTrainingExample(const std::string& trainingOutputFile,
                                                           const bool result,
                                                           TCONTAINER&& featureContainer)
  {
    ...
    if (!outfile.is_open()) {
      std::cout << "LArMvaHelper: could not open file for training examples at "
                << trainingOutputFile << std::endl;
    ...
    PANDORA_RETURN_RESULT_IF(
      pandora::STATUS_CODE_SUCCESS, !=, WriteFeaturesToFile(outfile, delimiter, featureContainer));
  ...
  template <typename TCONTAINER>
  bool LArMvaHelper::Classify(const MvaInterface& classifier,
                              const pandora::StringVector& featureOrder,
                              TCONTAINER&& featureContainer)
  {
    // Make a feature vector from the map and calculate the features
  ...
  template <typename TCONTAINER>
  double LArMvaHelper::CalculateClassificationScore(const MvaInterface& classifier,
                                                    TCONTAINER&& featureContainer)
  {
  ...
  template <typename TCONTAINER>
  double LArMvaHelper::CalculateProbability(const MvaInterface& classifier,
                                            TCONTAINER&& featureContainer)
  {
  ...
  template <typename... Ts, typename... TARGS>
  LArMvaHelper::MvaFeatureVector LArMvaHelper::CalculateFeatures(
    const MvaFeatureToolVector<Ts...>& featureToolVector,
    TARGS&&... args)
  {
    LArMvaHelper::MvaFeatureVector featureVector;
  ...
  template <typename... Ts, typename... TARGS>
  LArMvaHelper::MvaFeatureMap LArMvaHelper::CalculateFeatures(
    ...
    TARGS&&... args)
  {
    ...
    for (auto const& pFeatureToolName : featureToolOrder) {
      ...
      featureToolMap.at(pFeatureToolName)
        ->Run(featureMap, featureOrder, pFeatureToolName, std::forward<TARGS>(args)...);
    }
  ...
  template <typename T, typename... Ts, typename... TARGS>
  LArMvaHelper::MvaFeatureVector LArMvaHelper::CalculateFeaturesOfType(
    const MvaFeatureToolVector<Ts...>& featureToolVector,
    TARGS&&... args)
  {
  ...
  template <typename... Ts>
  pandora::StatusCode LArMvaHelper::AddFeatureToolToVector(
    pandora::AlgorithmTool* const pFeatureTool,
    MvaFeatureToolVector<Ts...>& featureToolVector)
  {
    if (MvaFeatureTool<Ts...>* const pCastFeatureTool =
          dynamic_cast<MvaFeatureTool<Ts...>* const>(pFeatureTool)) {
  ...
  template <typename... Ts>
  pandora::StatusCode LArMvaHelper::AddFeatureToolToMap(pandora::AlgorithmTool* const pFeatureTool,
                                                        std::string pFeatureToolName,
                                                        MvaFeatureToolMap<Ts...>& featureToolMap)
  {
    if (MvaFeatureTool<Ts...>* const pCastFeatureTool =
  ...
  template <typename TCONTAINER>
  inline pandora::StatusCode LArMvaHelper::WriteFeaturesToFile(std::ofstream& outfile,
                                                               const std::string& delimiter,
                                                               TCONTAINER&& featureContainer)
  {
    static_assert(
      std::is_same<typename std::decay<TCONTAINER>::type, LArMvaHelper::MvaFeatureVector>::value,
      "LArMvaHelper: Could not write training set example because a passed parameter was not a "
      "vector of MvaFeatures");
  ...
  template <typename TCONTAINER>
  pandora::StatusCode LArMvaHelper::WriteFeaturesToFileImpl(std::ofstream& outfile,
                                                            const std::string& delimiter,
                                                            TCONTAINER&& featureContainer)
  {
  ...
  template <typename TLIST, typename... TLISTS>
  LArMvaHelper::MvaFeatureVector LArMvaHelper::ConcatenateFeatureLists(TLIST&& featureList,
                                                                       TLISTS&&... featureLists)
  {
    static_assert(
      std::is_same<typename std::decay<TLIST>::type, LArMvaHelper::MvaFeatureVector>::value,
      "LArMvaHelper: Could not concatenate feature lists because one or more lists was not a "
      "vector of MvaFeatures");
    ...
    LArMvaHelper::MvaFeatureVector newFeatureVector =
      ConcatenateFeatureLists(std::forward<TLISTS>(featureLists)...);
