 ...
 */
  ...
  public:
    typedef std::unordered_map<const pandora::MCParticle*, const pandora::MCParticle*>
      MCRelationMap;
    typedef std::unordered_map<const pandora::MCParticle*, int> MCParticleIntMap;

    typedef std::unordered_map<const pandora::MCParticle*, const pandora::ParticleFlowObject*>
      MCToPfoMap;

    typedef std::unordered_map<const pandora::CaloHit*, const pandora::MCParticle*> CaloHitToMCMap;
    typedef std::unordered_map<const pandora::CaloHit*, const pandora::ParticleFlowObject*>
      CaloHitToPfoMap;
    ...
    typedef std::unordered_map<const pandora::ParticleFlowObject*, pandora::CaloHitList>
      PfoContributionMap;
    ...
    typedef std::map<const pandora::ParticleFlowObject*, MCParticleToSharedHitsVector>
      PfoToMCParticleHitSharingMap;
    typedef std::map<const pandora::MCParticle*, PfoToSharedHitsVector>
    ...
    public:
      ...
      bool
        m_foldBackHierarchy; ///< whether to fold the hierarchy back to the primary (neutrino) or leading particles (test beam)
    };
     ...
     */
    static bool DoesPrimaryMeetCriteria(
     ...
     *  @param  fCriteria the given criteria
     */
    static bool DoesLeadingMeetCriteria(
      const pandora::MCParticle* const pMCParticle,
      std::function<bool(const pandora::MCParticle* const)> fCriteria);
     ...
     */
    static void GetTrueNeutrinos(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static void GetTrueTestBeamParticles(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static const pandora::MCParticle* GetPrimaryMCParticle(
      const pandora::MCParticle* const pMCParticle);
     ...
     *  @return address of the primary parent mc particle
     */
    static const pandora::MCParticle* GetLeadingMCParticle(
      const pandora::MCParticle* const pMCParticle,
     ...
     */
    static void GetPrimaryMCParticleList(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static void GetLeadingMCParticleList(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static const pandora::MCParticle* GetParentMCParticle(
      const pandora::MCParticle* const pMCParticle);
     ...
     */
    static void GetMCPrimaryMap(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static void GetMCLeadingMap(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static void GetMCToSelfMap(const pandora::MCParticleList* const pMCParticleList,
     ...
     */
    static const pandora::MCParticle* GetMainMCParticle(
     ...
     */
    static void GetMCParticleToCaloHitMatches(const pandora::CaloHitList* const pCaloHitList,
     ...
     */
    static void SelectReconstructableMCParticles(
     ...
     *  @param  selectedMCParticlesToHitsMap the output mapping from selected mcparticles to their hits
     */
    static void SelectReconstructableTestBeamHierarchyMCParticles(
      const pandora::MCParticleList* pMCParticleList,
      const pandora::CaloHitList* pCaloHitList,
      const PrimaryParameters& parameters,
      std::function<bool(const pandora::MCParticle* const)> fCriteria,
     ...
     */
    static void GetPfoToReconstructable2DHitsMap(
     ...
     */
    static void GetTestBeamHierarchyPfoToReconstructable2DHitsMap(
      const pandora::PfoList& pfoList,
      const MCContributionMap& selectedMCParticleToHitsMap,
      PfoContributionMap& pfoToReconstructable2DHitsMap,
      const bool foldBackHierarchy);
     ...
     */
    static void GetClusterToReconstructable2DHitsMap(
     ...
     */
    static void SelectCaloHits(const pandora::CaloHitList* const pCaloHitList,
                               const MCRelationMap& mcToTargetMCMap,
     ...
     */
    static bool IsDescendentOf(const pandora::MCParticle* const pMCParticle,
                               const int pdg,
     ...
     */
    static void GetBreadthFirstHierarchyRepresentation(const pandora::MCParticle* const pMCParticle,
     ...
     *  @param  selectedMCParticlesToHitsMap the output mapping from selected mcparticles to their hits
     */
    static void SelectParticlesByHitCount(const pandora::MCParticleVector& candidateTargets,
     ...
     */
    static pandora::CaloHitList GetSharedHits(const pandora::CaloHitList& hitListA,
     ...
     */
    static bool AreTopologicallyContinuous(const pandora::MCParticle* const pMCParent,
  ...
  private:
     ...
     */
    static void CollectReconstructable2DHits(
      const pandora::ParticleFlowObject* const pPfo,
      const MCContributionMapVector& selectedMCParticleToHitsMaps,
     ...
     */
    static void CollectReconstructableTestBeamHierarchy2DHits(
      const pandora::ParticleFlowObject* const pPfo,
      const MCContributionMapVector& selectedMCParticleToHitsMaps,
      pandora::CaloHitList& reconstructableCaloHitList2D,
      const bool foldBackHierarchy);
     ...
     */
    static void SelectGoodCaloHits(const pandora::CaloHitList* const pSelectedCaloHitList,
                                   const MCRelationMap& mcToTargetMCMap,
     ...
     */
    static void SelectParticlesMatchingCriteria(
      const pandora::MCParticleVector& inputMCParticles,
      std::function<bool(const pandora::MCParticle* const)> fCriteria,
     ...
     *  @return boolean
     */
    static bool PassMCParticleChecks(const pandora::MCParticle* const pOriginalPrimary,
