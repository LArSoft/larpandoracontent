 ...
 */
  ...
  private:
     ...
     */
    template <typename T>
    static std::vector<T> MakeRandomisedSample(const std::vector<T>& t,
                                               std::mt19937& randomNumberGenerator);
  ...
  template <typename T>
  inline std::vector<T> LArDiscreteProbabilityHelper::MakeRandomisedSample(
  ...
  template <>
  inline DiscreteProbabilityVector LArDiscreteProbabilityHelper::MakeRandomisedSample(
    const DiscreteProbabilityVector& t,
    std::mt19937& randomNumberGenerator)
  {
  ...
  template <typename T>
  inline float LArDiscreteProbabilityHelper::GetElement(const std::vector<T>& t,
  ...
  template <>
  inline float LArDiscreteProbabilityHelper::GetElement(const DiscreteProbabilityVector& t,
                                                        const unsigned int index)
  {
