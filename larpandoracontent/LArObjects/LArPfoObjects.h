 ...
 */
  ...
  public:
     ...
     */
    LArTrackState(const pandora::CartesianVector& position,
 ...
 */
  ...
  public:
     ...
     */
    LArTrackTrajectoryPoint(const float projectedDistance,
 ...
 */
  ...
  public:
     ...
     */
    LArShowerPCA(const pandora::CartesianVector& centroid,
  ...
  inline LArTrackTrajectoryPoint::LArTrackTrajectoryPoint(const float projectedDistance,
                                                          const LArTrackState& larTrackState)
  ...
  inline int LArTrackTrajectoryPoint::GetIndex() const { return m_index; }
