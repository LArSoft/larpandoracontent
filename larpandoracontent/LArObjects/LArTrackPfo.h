 ...
 */
  ...
  public:
     ...
     */
    pandora::StatusCode Write(const pandora::ParticleFlowObject* const pObject,
     ...
     */
    pandora::StatusCode Create(const object_creation::ParticleFlowObject::Parameters& parameters,
                               const pandora::ParticleFlowObject*& pObject) const;
  };
  ...
  inline pandora::StatusCode LArTrackPfoFactory::Create(
    const Parameters& parameters,
    const pandora::ParticleFlowObject*& pObject) const
  {
    const LArTrackPfoParameters& larPfoParameters(
      dynamic_cast<const LArTrackPfoParameters&>(parameters));
  ...
  inline pandora::StatusCode LArTrackPfoFactory::Write(const pandora::ParticleFlowObject*,
