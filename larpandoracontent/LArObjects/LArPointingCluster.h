 ...
 */
  ...
  public:
    ...
    public:
      ...
      /**
         ...
         */
      Vertex(const pandora::Cluster* const pCluster,
     ...
     */
    LArPointingCluster(const pandora::Cluster* const pCluster,
  ...
  inline const pandora::Cluster* LArPointingCluster::GetCluster() const { return m_pCluster; }
  ...
  inline float LArPointingCluster::GetLength() const { return std::sqrt(this->GetLengthSquared()); }
  ...
  inline bool LArPointingCluster::Vertex::IsInitialized() const { return m_isInitialized; }
