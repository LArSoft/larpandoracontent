...
namespace lar_content {
  ...
  TrackOverlapResult::TrackOverlapResult(const unsigned int nMatchedSamplingPoints,
    ...
    , m_reducedChi2(0.f)
  {
    ...
    m_matchedFraction =
      static_cast<float>(m_nMatchedSamplingPoints) / static_cast<float>(m_nSamplingPoints);
  ...
  bool TrackOverlapResult::operator<(const TrackOverlapResult& rhs) const
  {
    ...
    if (!rhs.IsInitialized()) return false;
  ...
  {
    if (this == &rhs) throw StatusCodeException(STATUS_CODE_INVALID_PARAMETER);
  ...
  TransverseOverlapResult::TransverseOverlapResult()
    : TrackOverlapResult(), m_xOverlap(XOverlap(0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f))
  {}

  //------------------------------------------------------------------------------------------------------------------------------------------

  TransverseOverlapResult::TransverseOverlapResult(const unsigned int nMatchedSamplingPoints,
                                                   const unsigned int nSamplingPoints,
                                                   const float chi2,
  ...
  TransverseOverlapResult::TransverseOverlapResult(const TransverseOverlapResult& rhs)
    ...
    , m_xOverlap(rhs.IsInitialized() ? rhs.GetXOverlap() :
  ...
  TransverseOverlapResult& TransverseOverlapResult::operator=(const TransverseOverlapResult& rhs)
  {
    ...
    if (rhs.IsInitialized()) { m_xOverlap = rhs.GetXOverlap(); }
    else {
                                    ...
                                    const TransverseOverlapResult& rhs)
  {
    ...
    return TransverseOverlapResult(lhs.GetNMatchedSamplingPoints() +
                                     rhs.GetNMatchedSamplingPoints(),
                                   lhs.GetNSamplingPoints() + rhs.GetNSamplingPoints(),
                                   lhs.GetChi2() + rhs.GetChi2(),
                                   lhs.GetXOverlap() + rhs.GetXOverlap());
  }
  ...
  LongitudinalOverlapResult::LongitudinalOverlapResult()
    : TrackOverlapResult(), m_innerChi2(0.f), m_outerChi2(0.f)
  {}
  //------------------------------------------------------------------------------------------------------------------------------------------

  LongitudinalOverlapResult::LongitudinalOverlapResult(const TrackOverlapResult trackOverlapResult,
  ...
  LongitudinalOverlapResult::LongitudinalOverlapResult(const unsigned int nMatchedSamplingPoints,
                                                       const unsigned int nSamplingPoints,
                                                       const float chi2,
                                                       const float innerChi2,
                                                       const float outerChi2)
  ...
  LongitudinalOverlapResult& LongitudinalOverlapResult::operator=(
    const LongitudinalOverlapResult& rhs)
  {
    this->TrackOverlapResult::operator=(rhs);
  ...
  FragmentOverlapResult::FragmentOverlapResult()
    : TrackOverlapResult(), m_caloHitList(), m_clusterList()
  {}
  //------------------------------------------------------------------------------------------------------------------------------------------

  FragmentOverlapResult::FragmentOverlapResult(const TrackOverlapResult trackOverlapResult,
  ...
  FragmentOverlapResult::FragmentOverlapResult(const unsigned int nMatchedSamplingPoints,
                                               const unsigned int nSamplingPoints,
                                               const float chi2,
                                               const pandora::CaloHitList& caloHitList,
                                               const pandora::ClusterList& clusterList)
  ...
  {
    if (m_caloHitList.empty()) throw StatusCodeException(STATUS_CODE_INVALID_PARAMETER);
  ...
  DeltaRayOverlapResult::DeltaRayOverlapResult()
    : TransverseOverlapResult(), m_commonMuonPfoList(PfoList())
  {}

  //------------------------------------------------------------------------------------------------------------------------------------------

  DeltaRayOverlapResult::DeltaRayOverlapResult(const unsigned int nMatchedSamplingPoints,
                                               const unsigned int nSamplingPoints,
                                               const float chi2,
                                               const XOverlap& xOverlap,
