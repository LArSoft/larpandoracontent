 ...
 */
  ...
  public:
     ...
     */
    TwoViewDeltaRayOverlapResult(const TwoViewXOverlap& xOverlap,
  ...
  private:
    ...
    pandora::PfoList
      m_commonMuonPfoList; ///< The list of muon pfos whose clusters lie close to delta ray clusters in all views
    const pandora::Cluster*
      m_pBestMatchedCluster; ///< The largest cluster that lies on the projected hits
    pandora::ClusterList
      m_matchedClusterList;    ///< The list of clusters that lie on the projected hits
 ...
 */
  ...
  protected:
    ...
    float
      m_matchingScore; ///< The compatability score for the two objects associated with the overlap result
  };
 ...
 */
  ...
  public:
     ...
     */
    TwoViewTransverseOverlapResult(const float matchingScore,
  ...
  inline bool TwoViewDeltaRayOverlapResult::IsInitialized() const { return m_isInitialized; }
  ...
  inline bool TrackTwoViewOverlapResult::IsInitialized() const { return m_isInitialized; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TrackTwoViewOverlapResult::GetMatchingScore() const
  {
    if (m_isInitialized) return m_matchingScore;
  ...
  {
    if (m_isInitialized)
      return static_cast<unsigned int>(m_downsamplingFactor *
  ...
  {
    if (m_isInitialized) return m_correlationCoefficient;
  ...
  {
    if (m_isInitialized)
      return (m_nSamplingPoints > 0 ? static_cast<float>(m_nMatchedSamplingPoints) /
                                        static_cast<float>(m_nSamplingPoints) :
                                      0.f);
  ...
  {
    if (m_isInitialized) return m_twoViewXOverlap;
