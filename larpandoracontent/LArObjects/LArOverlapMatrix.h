 ...
 */
  ...
  public:
    ...
    public:
      /**
         ...
         */
      Element(const pandora::Cluster* const pCluster1,
     ...
     *  @return boolean
     */
    bool DefaultAmbiguityFunction(const pandora::ClusterList& clusterList1,
                                  const pandora::ClusterList& clusterList2,
                                  const pandora::Cluster*& pCluster1,
                                  const pandora::Cluster*& pCluster2) const;
     ...
     */
    const OverlapResult& GetOverlapResult(const pandora::Cluster* const pCluster1,
     ...
     *  @param  overlapResult the overlap result
     */
    void SetOverlapResult(const pandora::Cluster* const pCluster1,
                          const pandora::Cluster* const pCluster2,
                          const OverlapResult& overlapResult);
     ...
     *  @param  overlapResult the overlap result
     */
    void ReplaceOverlapResult(const pandora::Cluster* const pCluster1,
                              const pandora::Cluster* const pCluster2,
                              const OverlapResult& overlapResult);
  ...
  template <typename T>
  inline void OverlapMatrix<T>::GetNConnections(const pandora::Cluster* const pCluster,
                                                const bool ignoreUnavailable,
                                                unsigned int& n1,
                                                unsigned int& n2) const
  {
  ...
  template <typename T>
  inline void OverlapMatrix<T>::GetConnectedElements(const pandora::Cluster* const pCluster,
                                                     const bool ignoreUnavailable,
                                                     ElementList& elementList) const
  {
  ...
  template <typename T>
  inline const typename OverlapMatrix<T>::OverlapList& OverlapMatrix<T>::GetOverlapList(
    const pandora::Cluster* const pCluster1) const
  {
  ...
  template <typename T>
  inline const typename OverlapMatrix<T>::ClusterNavigationMap&
  OverlapMatrix<T>::GetClusterNavigationMap12() const
  {
  ...
  template <typename T>
  inline const typename OverlapMatrix<T>::ClusterNavigationMap&
  OverlapMatrix<T>::GetClusterNavigationMap21() const
  {
  ...
  template <typename T>
  inline OverlapMatrix<T>::Element::Element(const pandora::Cluster* const pCluster1,
                                            const pandora::Cluster* const pCluster2,
                                            const OverlapResult& overlapResult)
  ...
  template <typename T>
  inline const typename OverlapMatrix<T>::OverlapResult&
  OverlapMatrix<T>::Element::GetOverlapResult() const
  {
