 ...
 */
  ...
  public:
    ...
    public:
      /**
         ...
         */
      Element(const pandora::Cluster* const pClusterU,
     ...
     *  @return boolean
     */
    bool DefaultAmbiguityFunction(const pandora::ClusterList& clusterListU,
     ...
     */
    void GetNConnections(const pandora::Cluster* const pCluster,
     ...
     */
    const OverlapResult& GetOverlapResult(const pandora::Cluster* const pClusterU,
                                          const pandora::Cluster* const pClusterV,
     ...
     */
    const OverlapList& GetOverlapList(const pandora::Cluster* const pClusterU,
                                      const pandora::Cluster* const pClusterV) const;
     ...
     *  @param  overlapResult the overlap result
     */
    void SetOverlapResult(const pandora::Cluster* const pClusterU,
                          const pandora::Cluster* const pClusterV,
                          const pandora::Cluster* const pClusterW,
                          const OverlapResult& overlapResult);
     ...
     *  @param  overlapResult the overlap result
     */
    void ReplaceOverlapResult(const pandora::Cluster* const pClusterU,
                              const pandora::Cluster* const pClusterV,
                              const pandora::Cluster* const pClusterW,
                              const OverlapResult& overlapResult);
  ...
  private:
     ...
     *  @param  clusterListW connected w clusters
     */
    void ExploreConnections(const pandora::Cluster* const pCluster,
                            const bool ignoreUnavailable,
                            pandora::ClusterList& clusterListU,
                            pandora::ClusterList& clusterListV,
                            pandora::ClusterList& clusterListW) const;
  ...
  template <typename T>
  inline void OverlapTensor<T>::GetNConnections(const pandora::Cluster* const pCluster,
                                                const bool ignoreUnavailable,
                                                unsigned int& nU,
                                                unsigned int& nV,
                                                unsigned int& nW) const
  ...
  template <typename T>
  inline void OverlapTensor<T>::GetConnectedElements(const pandora::Cluster* const pCluster,
                                                     const bool ignoreUnavailable,
                                                     ElementList& elementList) const
  {
  ...
  inline const typename OverlapTensor<T>::OverlapResult& OverlapTensor<T>::GetOverlapResult(
    const pandora::Cluster* const pClusterU,
    const pandora::Cluster* const pClusterV,
    const pandora::Cluster* const pClusterW) const
  {
  ...
  template <typename T>
  inline const typename OverlapTensor<T>::ClusterNavigationMap&
  OverlapTensor<T>::GetClusterNavigationMapUV() const
  {
  ...
  template <typename T>
  inline const typename OverlapTensor<T>::ClusterNavigationMap&
  OverlapTensor<T>::GetClusterNavigationMapVW() const
  {
  ...
  template <typename T>
  inline const typename OverlapTensor<T>::ClusterNavigationMap&
  OverlapTensor<T>::GetClusterNavigationMapWU() const
  {
  ...
  template <typename T>
  inline OverlapTensor<T>::Element::Element(const pandora::Cluster* const pClusterU,
                                            const pandora::Cluster* const pClusterV,
                                            const pandora::Cluster* const pClusterW,
                                            const OverlapResult& overlapResult)
  ...
  template <typename T>
  inline const typename OverlapTensor<T>::OverlapResult&
  OverlapTensor<T>::Element::GetOverlapResult() const
  {
