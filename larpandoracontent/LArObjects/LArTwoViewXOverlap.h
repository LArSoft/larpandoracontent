 ...
 */
  ...
  inline TwoViewXOverlap::TwoViewXOverlap(const float xMin0,
                                          const float xMax0,
                                          const float xMin1,
                                          const float xMax1)
    : m_xMin0(xMin0)
  ...
  inline float TwoViewXOverlap::GetXMin0() const { return m_xMin0; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXMax0() const { return m_xMax0; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXMin1() const { return m_xMin1; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXMax1() const { return m_xMax1; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXSpan0() const { return std::fabs(m_xMax0 - m_xMin0); }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXSpan1() const { return std::fabs(m_xMax1 - m_xMin1); }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetTwoViewXOverlapSpan() const { return m_xOverlapSpan; }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetTwoViewXOverlapMin() const { return std::max(m_xMin0, m_xMin1); }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetTwoViewXOverlapMax() const { return std::min(m_xMax0, m_xMax1); }

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline float TwoViewXOverlap::GetXOverlapFraction0() const
  {
    return (std::numeric_limits<float>::epsilon() < this->GetXSpan0()) ?
             m_xOverlapSpan / this->GetXSpan0() :
             0.f;
  }
  ...
  {
    return (std::numeric_limits<float>::epsilon() < this->GetXSpan1()) ?
             m_xOverlapSpan / this->GetXSpan1() :
             0.f;
  }
