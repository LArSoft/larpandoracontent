 ...
 */
  ...
  public:
     ...
     */
    virtual double CalculateClassificationScore(
      const MvaTypes::MvaFeatureVector& features) const = 0;
  ...
  inline MvaTypes::InitializedDouble::InitializedDouble(const double number)
    : m_number(number), m_isInitialized(true)
  {}
  ...
  inline MvaTypes::InitializedDouble& MvaTypes::InitializedDouble::operator=(
    const InitializedDouble rhs)
  {
    if (this != &rhs) {
  ...
  inline bool MvaTypes::InitializedDouble::IsInitialized() const { return m_isInitialized; }
