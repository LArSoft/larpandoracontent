 ...
 */
  ...
  public:
     ...
     */
    template <typename TX, typename TY>
    DiscreteProbabilityVector(const InputData<TX, TY>& inputData,
     ...
     */
    void GetAllAtIndex(const unsigned int index,
                       float& x,
  ...
  private:
    ...
    public:
      /**
         ...
         */
      DiscreteProbabilityDatum(const float x,
  ...
  inline float DiscreteProbabilityVector::GetProbability(const unsigned int index) const
  {
    ...
    return m_discreteProbabilityData.at(index).GetDensityDatum() *
           (m_useWidths ? m_discreteProbabilityData.at(index).GetWidth() : 1.f);
  }
  ...
  inline void DiscreteProbabilityVector::GetAllAtIndex(const unsigned int index,
                                                       float& x,
                                                       float& probabilityDensity,
                                                       float& cumulativeProbability,
                                                       float& width) const
  ...
  inline float DiscreteProbabilityVector::DiscreteProbabilityDatum::GetX() const { return m_x; }
