...
namespace lar_content {
  ...
  bool CutPfoCharacterisationAlgorithm::IsClearTrack(const Cluster* const pCluster) const
  {
    ...
    try {
      ...
      straightLineLength = (slidingFitResult.GetGlobalMaxLayerPosition() -
    ...
    if ((dTdLMax - dTdLMin) / straightLineLength > m_dTdLWidthRatioCut) return false;
  ...
  bool CutPfoCharacterisationAlgorithm::IsClearTrack(
  ...
  StatusCode CutPfoCharacterisationAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(
      ...
      !=,
      XmlHelper::ReadValue(xmlHandle, "PostBranchAddition", m_postBranchAddition));
    ...
    PANDORA_RETURN_RESULT_IF_AND_IF(
      ...
      STATUS_CODE_NOT_FOUND,
      !=,
      XmlHelper::ReadValue(xmlHandle, "DTDLWidthRatioCut", m_dTdLWidthRatioCut));
