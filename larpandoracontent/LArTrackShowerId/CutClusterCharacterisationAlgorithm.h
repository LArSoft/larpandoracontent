 ...
 */
  ...
  public:
     ...
     */
    static float GetVertexDistance(const pandora::Algorithm* const pAlgorithm,
     ...
     */
    static float GetShowerFitWidth(const pandora::Algorithm* const pAlgorithm,
                                   const pandora::Cluster* const pCluster,
  ...
  private:
    ...
    float
      m_pathLengthRatioCut; ///< The maximum ratio of path length to straight line length to qualify as a track
    float
      m_rTWidthRatioCut; ///< The maximum ratio of transverse fit position width to straight line length to qualify as a track
    float
      m_vertexDistanceRatioCut; ///< The maximum ratio of vertex separation to straight line length to qualify as a track
    float
      m_showerWidthRatioCut; ///< The maximum ratio of shower fit width to straight line length to qualify as a track
  };
