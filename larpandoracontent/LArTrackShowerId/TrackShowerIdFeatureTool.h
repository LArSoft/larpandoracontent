...
namespace lar_content {
  ...
  typedef MvaFeatureTool<const pandora::Algorithm* const, const pandora::Cluster* const>
    ClusterCharacterisationFeatureTool;
  typedef MvaFeatureTool<const pandora::Algorithm* const, const pandora::ParticleFlowObject* const>
    PfoCharacterisationFeatureTool;
 ...
 */
  ...
  public:
    ...
    void Run(LArMvaHelper::MvaFeatureMap& featureMap,
  ...
  private:
    ...
    */
    float CalculateShowerFitWidth(const pandora::Algorithm* const pAlgorithm,
 ...
 */
  ...
  private:
     ...
     */
    void CalculateVariablesSlidingLinearFit(const pandora::Cluster* const pCluster,
    ...
    unsigned int m_slidingLinearFitWindow; ///< The sliding linear fit window
    unsigned int
      m_slidingLinearFitWindowLarge; ///< The sliding linear fit window - should be large, providing a simple linear fit
  };
 ...
 */
  ...
  private:
     ...
     */
    float CalculateVertexDistance(const pandora::Algorithm* const pAlgorithm,
                                  const pandora::Cluster* const pCluster) const;
 ...
 */
  ...
  private:
     ...
     */
    void CalculateChargeDistribution(const pandora::CaloHitList& caloHitList,
     ...
     *  return conicalness
     */
    float CalculateConicalness(const pandora::CaloHitList& caloHitList,
                               const pandora::CartesianVector& pfoStart,
                               const pandora::CartesianVector& pfoDir,
 ...
 */
  ...
  private:
     ...
     */
    void Divide3DCaloHitList(const pandora::Algorithm* const pAlgorithm,
     ...
     */
    float OpeningAngle(const pandora::CartesianVector& principal,
 ...
 */
  ...
  public:
    ...
    public:
      ...
      /**
         ...
         *  @return boolean
         */
      bool operator()(const pandora::CaloHit* const left,
                      const pandora::CaloHit* const right) const;
  ...
  private:
     ...
     */
    void CalculateChargeVariables(const pandora::Algorithm* const pAlgorithm,
                                  const pandora::Cluster* const pCluster,
                                  float& totalCharge,
                                  float& chargeSigma,
                                  float& chargeMean,
     ...
     *
     */
    void OrderCaloHitsByDistanceToVertex(const pandora::Algorithm* const pAlgorithm,
                                         const pandora::Cluster* const pCluster,
    ...
    float
      m_endChargeFraction; ///< Fraction of hits that will be considered to calculate end charge (default 10%)
  };
