...
namespace lar_content {
  ...
  StatusCode PfoValidationAlgorithm::Run()
  {
    ...
    LArMCParticleHelper::GetPfoToReconstructable2DHitsMap(finalStatePfos,
    ...
    LArMonitoringHelper::PrintMatchingTable(
      orderedPfoVector, orderedMCParticleVector, mcParticleToPfoHitSharingMap, m_nMatchesToShow);
  ...
  StatusCode PfoValidationAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
  {
    ...
    PANDORA_RETURN_RESULT_IF_AND_IF(
      ...
      STATUS_CODE_NOT_FOUND,
      !=,
      XmlHelper::ReadValue(xmlHandle, "NumMatchesToShow", m_nMatchesToShow));
