 ...
 */
  ...
  public:
     ...
     */
    void SelectSlices(const pandora::Algorithm* const pAlgorithm,
  ...
  protected:
    ...
    float
      m_threshold; ///< The minimum cut threshold to retain a slice (< 0 for no threshold) - default -1
    std::string
      m_cutVariable; ///< The variable to cut on ("purity" or "completeness") - default "completeness"
  };
