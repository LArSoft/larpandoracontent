 ...
 */
  ...
  public:
    ...
    private:
      ...
      unsigned int
        m_layerFitHalfWindow; ///< Layer fit half window, used for calculating sliding muon track width
      ...
      float
        m_trackResidualQuantile; ///< Track residual quantile, used for calculating muon track width
      unsigned int
        m_minClustersPassingId; ///< Match pfo if at sufficient clusters in pfo pass the cluster particle id logic
    };
  };
