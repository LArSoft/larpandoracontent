  ...
  private:
    ...
    public:
      ...
      /**
         ...
         */
      pandora::CartesianVector GetLineIntersection(const pandora::CartesianVector& a0,
                                                   const pandora::CartesianVector& a) const;
     ...
     */
    void GetSelectedCaloHits(const pandora::CaloHitList& inputCaloHitList,
     ...
     */
    void GetTPCIntercepts(const pandora::CartesianVector& a0,
    ...
    bool
      m_selectAllBeamParticles; ///< First approach: select all beam particles, as opposed to selecting all cosmics
    bool
      m_selectOnlyFirstSliceBeamParticles; ///< First approach: select first slice beam particles, cosmics for all subsequent slices
    ...
    float
      m_projectionIntersectionCut; ///< Projection intersection distance cut, used in beam event selection
    float
      m_closestDistanceCut; ///< Closest distance (of hit to beam spot), used in beam event selection
    float
      m_angleToBeamCut; ///< Angle between major axis and beam direction, used in beam event selection
