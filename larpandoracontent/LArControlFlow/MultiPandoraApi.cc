...
const pandora::Pandora* MultiPandoraApi::GetPandoraInstance(
...
const PandoraInstanceList& MultiPandoraApi::GetDaughterPandoraInstanceList(
  const pandora::Pandora* const pPrimaryPandora)
{
...
const pandora::Pandora* MultiPandoraApi::GetPrimaryPandoraInstance(
