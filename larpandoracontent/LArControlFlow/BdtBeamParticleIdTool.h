 ...
 */
  ...
  private:
    ...
    public:
      ...
      /**
         ...
         */
      pandora::CartesianVector GetLineIntersection(const pandora::CartesianVector& point,
    ...
    public:
      ...
      /**
         ...
         */
      void Initialize(const float larTPCMinX,
    ...
    private:
      ...
      pandora::CartesianVector
        m_beamLArTPCIntersection;               ///< Intersection of beam and global LArTPC volume
    ...
    public:
      /**
         ...
         */
      SliceFeatures(const pandora::PfoList& nuPfos,
    ...
    private:
      /**
         ...
         */
      void GetLeadingCaloHits(const pandora::CaloHitList& inputCaloHitList,
      ...
      /**
         ...
         */
      void GetLArTPCIntercepts(const pandora::CartesianVector& a0,
                               const pandora::CartesianVector& majorAxis,
                               pandora::CartesianVector& interceptOne,
                               pandora::CartesianVector& interceptTwo) const;
     ...
     */
    void GetSliceFeatures(const SliceHypotheses& nuSliceHypotheses,
                          const SliceHypotheses& crSliceHypotheses,
     ...
     */
    void SelectAllPfos(const pandora::Algorithm* const pAlgorithm,
                       const SliceHypotheses& hypotheses,
                       pandora::PfoList& selectedPfos) const;
     ...
     */
    void GetBestMCSliceIndices(const pandora::Algorithm* const pAlgorithm,
     ...
     */
    void PopulateMCParticleToHitsMap(MCParticleToIntMap& mcParticleToIntMap,
     ...
     */
    void Collect2DHits(const pandora::PfoList& pfos,
     ...
     *  @param  selectedPfos the list of pfos to populate
     */
    void SelectPfosByAdaBDTScore(const pandora::Algorithm* const pAlgorithm,
                                 const SliceHypotheses& nuSliceHypotheses,
                                 const SliceHypotheses& crSliceHypotheses,
    ...
    // Training
    bool
      m_useTrainingMode; ///< Should use training mode. If true, training examples will be written to the output file
    ...
    std::string
      m_filePathEnvironmentVariable; ///< The environment variable providing a list of paths to bdt files
  ...
  inline void BdtBeamParticleIdTool::SliceFeatureParameters::SetBeamLArTPCIntersection(
  ...
  inline void BdtBeamParticleIdTool::SliceFeatureParameters::SetBeamDirection(
  ...
  inline void BdtBeamParticleIdTool::SliceFeatureParameters::SetSelectedFraction(
  ...
  inline void BdtBeamParticleIdTool::SliceFeatureParameters::SetNSelectedHits(
  ...
  inline void BdtBeamParticleIdTool::SliceFeatureParameters::SetContainmentLimit(
  ...
  inline const BdtBeamParticleIdTool::PlaneVector&
  BdtBeamParticleIdTool::SliceFeatureParameters::GetPlanes() const
  {
  ...
  BdtBeamParticleIdTool::SliceFeatureParameters::GetBeamLArTPCIntersection() const
  {
  ...
  inline const pandora::CartesianVector&
  BdtBeamParticleIdTool::SliceFeatureParameters::GetBeamDirection() const
  {
