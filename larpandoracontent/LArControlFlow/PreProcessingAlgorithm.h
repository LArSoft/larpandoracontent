 ...
 */
  ...
  private:
     ...
     */
    void GetFilteredCaloHitList(const pandora::CaloHitList& inputList,
    ...
    unsigned int
      m_maxEventHits; ///< The maximum number of hits in an event to proceed with the reconstruction
    ...
    std::string
      m_filteredCaloHitListName; ///< The output calo hit list name for all U, V and W hits
    std::string
      m_currentCaloHitListReplacement; ///< The name of the calo hit list to replace the current list (optional)
  };
