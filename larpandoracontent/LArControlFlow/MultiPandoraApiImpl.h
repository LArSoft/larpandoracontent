...
private:
  ...
  /**
     ...
     */
  const pandora::Pandora* GetPandoraInstance(const pandora::Pandora* const pPrimaryPandora,
  ...
  /**
     ...
     */
  const PandoraInstanceList& GetDaughterPandoraInstanceList(
    const pandora::Pandora* const pPrimaryPandora) const;
  ...
  /**
     ...
     */
  const pandora::Pandora* GetPrimaryPandoraInstance(
    const pandora::Pandora* const pDaughterPandora) const;
  ...
  /**
     ...
     *  @param  pDaughterPandora the address of the daughter pandora instance
     */
  void AddDaughterPandoraInstance(const pandora::Pandora* const pPrimaryPandora,
  ...
  PandoraInstanceMap
    m_primaryToDaughtersMap; ///< The map from primary pandora instance to list of daughter pandora instances
  PandoraRelationMap
    m_daughterToPrimaryMap; ///< The map from daughter pandora instance to primary pandora instance
