...
public:
  ...
  /**
     ...
     */
  static const pandora::Pandora* GetPandoraInstance(const pandora::Pandora* const pPrimaryPandora,
  ...
  /**
     ...
     */
  static const PandoraInstanceList& GetDaughterPandoraInstanceList(
  ...
  /**
     ...
     */
  static const pandora::Pandora* GetPrimaryPandoraInstance(
  ...
  /**
     ...
     *  @param  pDaughterPandora the address of the daughter pandora instance
     */
  static void AddDaughterPandoraInstance(const pandora::Pandora* const pPrimaryPandora,
                                         const pandora::Pandora* const pDaughterPandora);
