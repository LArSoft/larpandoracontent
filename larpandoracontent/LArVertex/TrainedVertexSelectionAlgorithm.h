 ...
 */
  ...
  public:
    ...
    public:
      /**
         ...
         */
      VertexFeatureInfo(const float beamDeweighting,
    ...
    public:
      /**
         ...
         */
      EventFeatureInfo(const float eventShoweryness,
  ...
  protected:
     ...
     */
    void CalculateShowerClusterList(const pandora::ClusterList& inputClusterList,
     ...
     */
    void GetShowerLikeClusterEndPoints(const pandora::ClusterList& clusterList,
     ...
     */
    void PopulateKdTree(const pandora::ClusterList& clusterList,
                        HitKDTree2D& kdTree,
     ...
     *  @return boolean
     */
    bool AddClusterToShower(const ClusterEndPointsMap& clusterEndPointsMap,
                            pandora::ClusterList& availableShowerLikeClusters,
                            const pandora::Cluster* const pCluster,
                            pandora::ClusterList& showerCluster) const;
     ...
     *  @return boolean
     */
    bool AddClusterToShower(HitKDTree2D& kdTree,
     ...
     */
    EventFeatureInfo CalculateEventFeatures(const pandora::ClusterList& clusterListU,
                                            const pandora::ClusterList& clusterListV,
                                            const pandora::ClusterList& clusterListW,
                                            const pandora::VertexVector& vertexVector) const;
     ...
     */
    void IncrementShoweryParameters(const pandora::ClusterList& clusterList,
     ...
     */
    void GetLegacyEventShapeFeatures(const pandora::ClusterList& clusterList,
                                     float& eventVolume,
     ...
     *  @param  longitudinality the event longitudinality
     */
    void GetEventShapeFeatures(const ClusterListMap& clusterListMap,
                               float& eventArea,
                               float& longitudinality) const;
     ...
     */
    void UpdateSpanCoordinate(const float minPositionCoord,
     ...
     */
    float GetCoordinateSpan(const pandora::InputFloat& minCoord,
                            const pandora::InputFloat& maxCoord) const;
     ...
     */
    void AddEventFeaturesToVector(const EventFeatureInfo& eventFeatureInfo,
     ...
     */
    void PopulateVertexFeatureInfoMap(const BeamConstants& beamConstants,
     ...
     */
    void PopulateInitialScoreList(VertexFeatureInfoMap& vertexFeatureInfoMap,
                                  const pandora::Vertex* const pVertex,
     ...
     */
    void GetBestRegionVertices(VertexScoreList& initialScoreList,
                               pandora::VertexVector& bestRegionVertices) const;
     ...
     *  @param  kdTreeMap
     */
    void ProduceTrainingSets(const pandora::VertexVector& vertexVector,
     ...
     *  @param  kdTreeMap the kd tree map
     */
    void CalculateRPhiScores(pandora::VertexVector& vertexVector,
                             VertexFeatureInfoMap& vertexFeatureInfoMap,
                             const KDTreeMap& kdTreeMap) const;
     ...
     */
    const pandora::Vertex* ProduceTrainingExamples(
     ...
     */
    void GetBestVertex(const pandora::VertexVector& vertexVector,
     ...
     */
    void GetSharedFeatures(const pandora::Vertex* const pVertex1,
     ...
     */
    void IncrementSharedAxisValues(const pandora::CartesianVector pos1,
     ...
     *  @param  useRPhi whether to include the r/phi feature
     */
    void AddVertexFeaturesToVector(const VertexFeatureInfo& vertexFeatureInfo,
     ...
     *  @param  featureVector the vector of floats to append
     */
    void AddSharedFeaturesToVector(const VertexSharedFeatureInfo& vertexSharedFeatureInfo,
                                   LArMvaHelper::MvaFeatureVector& featureVector) const;
     ...
     */
    void PopulateFinalVertexScoreList(const VertexFeatureInfoMap& vertexFeatureInfoMap,
    ...
    float
      m_beamDeweightingConstant; ///< The beam deweighting constant for the initial region score list
    float
      m_localAsymmetryConstant; ///< The local asymmetry constant for the initial region score list
    float
      m_globalAsymmetryConstant; ///< The global asymmetry constant for the initial region score list
    float
      m_showerAsymmetryConstant; ///< The shower asymmetry constant for the initial region score list
    ...
    bool
      m_useShowerClusteringApproximation; ///< Whether to use the shower clustering distance approximation
    ...
    float
      m_maxTrueVertexRadius; ///< The maximum distance at which a vertex candidate can be considered the 'true' vertex
    bool m_useRPhiFeatureForRegion; ///< Whether to use the r/phi feature for the region vertex
    bool
      m_dropFailedRPhiFastScoreCandidates; ///< Whether to drop candidates that fail the r/phi fast score test
  ...
  inline TrainedVertexSelectionAlgorithm::VertexFeatureInfo::VertexFeatureInfo(
  ...
  inline TrainedVertexSelectionAlgorithm::EventFeatureInfo::EventFeatureInfo(
  ...
  inline TrainedVertexSelectionAlgorithm::VertexSharedFeatureInfo::VertexSharedFeatureInfo(
