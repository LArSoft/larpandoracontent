...
namespace lar_content {
  ...
  void TrainedVertexSelectionAlgorithm::CalculateShowerClusterList(
  ...
  void TrainedVertexSelectionAlgorithm::PopulateKdTree(const ClusterList& clusterList,
                                                       HitKDTree2D& kdTree,
  ...
  bool TrainedVertexSelectionAlgorithm::AddClusterToShower(
  ...
  bool TrainedVertexSelectionAlgorithm::AddClusterToShower(HitKDTree2D& kdTree,
  ...
  void TrainedVertexSelectionAlgorithm::IncrementShoweryParameters(const ClusterList& clusterList,
  ...
  inline bool TrainedVertexSelectionAlgorithm::IsClusterShowerLike(
  ...
  void TrainedVertexSelectionAlgorithm::GetLegacyEventShapeFeatures(const ClusterList& clusterList,
                                                                    float& eventVolume,
  ...
  void TrainedVertexSelectionAlgorithm::GetEventShapeFeatures(const ClusterListMap& clusterListMap,
                                                              float& eventArea,
                                                              float& longitudinality) const
  {
  ...
  void TrainedVertexSelectionAlgorithm::Get2DSpan(const ClusterList& clusterList,
                                                  float& xSpan,
                                                  float& zSpan) const
  {
  ...
  inline void TrainedVertexSelectionAlgorithm::UpdateSpanCoordinate(const float minPositionCoord,
  ...
  inline float TrainedVertexSelectionAlgorithm::GetCoordinateSpan(const InputFloat& minCoord,
  ...
  void TrainedVertexSelectionAlgorithm::AddEventFeaturesToVector(
  ...
  void TrainedVertexSelectionAlgorithm::PopulateVertexFeatureInfoMap(
  ...
  void TrainedVertexSelectionAlgorithm::GetBestRegionVertices(
  ...
  void TrainedVertexSelectionAlgorithm::ProduceTrainingSets(
  ...
  const pandora::Vertex* TrainedVertexSelectionAlgorithm::ProduceTrainingExamples(
    const VertexVector& vertexVector,
  ...
  void TrainedVertexSelectionAlgorithm::GetSharedFeatures(const Vertex* const pVertex1,
  ...
  void TrainedVertexSelectionAlgorithm::IncrementSharedAxisValues(const CartesianVector pos1,
  ...
  bool TrainedVertexSelectionAlgorithm::IsHitInBox(const CartesianVector& hitPos,
  ...
  void TrainedVertexSelectionAlgorithm::GetBestVertex(const VertexVector& vertexVector,
  ...
  void TrainedVertexSelectionAlgorithm::PopulateFinalVertexScoreList(
    const VertexFeatureInfoMap& vertexFeatureInfoMap,
