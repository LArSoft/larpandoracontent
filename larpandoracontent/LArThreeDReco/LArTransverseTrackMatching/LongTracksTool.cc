...
namespace lar_content {
  ...
  bool LongTracksTool::HasLongDirectConnections(IteratorList::const_iterator iIter,
  ...
  bool LongTracksTool::IsLongerThanDirectConnections(
  ...
  bool LongTracksTool::Run(ThreeViewTransverseTracksAlgorithm* const pAlgorithm,
  ...
  void LongTracksTool::FindLongTracks(const TensorType& overlapTensor,
  ...
  void LongTracksTool::SelectLongElements(const TensorType::ElementList& elementList,
                                          const pandora::ClusterSet& usedClusters,
