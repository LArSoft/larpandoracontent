...
namespace lar_content {
  ...
  void MatchingBaseAlgorithm::SelectInputClusters(const ClusterList* const pInputClusterList,
                                                  ClusterList& selectedClusterList) const
  {
    if (!pInputClusterList) throw StatusCodeException(STATUS_CODE_INVALID_PARAMETER);
  ...
  void MatchingBaseAlgorithm::SetPfoParameters(
  ...
  void MatchingBaseAlgorithm::SetPfoParticleId(
    PandoraContentApi::ParticleFlowObject::Parameters& pfoParameters) const
  {
  ...
  StatusCode MatchingBaseAlgorithm::Run()
  {
    try {
      ...
      if (STATUS_CODE_SUCCESS != statusCodeException.GetStatusCode()) throw statusCodeException;
    }
