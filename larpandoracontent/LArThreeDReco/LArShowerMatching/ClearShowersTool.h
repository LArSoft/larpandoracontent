 ...
 */
  ...
  public:
     ...
     *  @return boolean
     */
    static bool HasLargeDirectConnections(IteratorList::const_iterator iIter,
     ...
     */
    static bool IsLargerThanDirectConnections(IteratorList::const_iterator iIter,
  ...
  private:
     ...
     */
    void FindClearShowers(const TensorType& overlapTensor,
     ...
     */
    void SelectLargeShowerElements(const TensorType::ElementList& elementList,
                                   const pandora::ClusterSet& usedClusters,
    ...
    float
      m_minXOverlapSpanRatio; ///< The min ratio between 1st and 2nd highest x-overlap spans for simple ambiguity resolution
