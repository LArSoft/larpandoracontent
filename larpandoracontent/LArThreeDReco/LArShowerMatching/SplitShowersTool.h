 ...
 */
  ...
  private:
     ...
     */
    void FindSplitShowers(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     */
    bool PassesElementCuts(TensorType::ElementList::const_iterator eIter,
     ...
     */
    void FindShowerMerges(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     */
    bool CheckClusterProximities(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     *  @param  clusterList the cluster list
     */
    bool CheckClusterVertexRelations(ThreeViewShowersAlgorithm* const pAlgorithm,
                                     const pandora::ClusterList& clusterList) const;
     ...
     */
    bool CheckClusterSplitPositions(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     */
    void GetSplitXDetails(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     */
    void SpecifyClusterMerges(ThreeViewShowersAlgorithm* const pAlgorithm,
     ...
     */
    bool ApplyChanges(ThreeViewShowersAlgorithm* const pAlgorithm,
    ...
    bool
      m_checkClusterProximities; ///< Whether to check the proximities of the candidate split shower clusters
    float m_maxClusterSeparation; ///< The maximum separation for clusters to be merged

    bool
      m_checkClusterVertexRelations; ///< Whether to check the consistency of the clusters with the event vertex
    float
    ...
    unsigned int
      m_maxVertexAssociations; ///< The maximum number of vertex associations for clusters to be merged

    bool
      m_checkClusterSplitPositions; ///< Whether to check the cluster split positions, if there are splits in multiple views
    float
      m_vetoMergeXDifference; ///< The x distance between split positions in two views below which may refuse a merge
    float
      m_vetoMergeXOverlap; ///< The x overlap between candidate cluster sliding fits below which may refuse a merge
  };
