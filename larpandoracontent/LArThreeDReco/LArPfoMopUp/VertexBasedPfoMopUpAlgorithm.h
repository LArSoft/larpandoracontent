 ...
 */
  ...
  protected:
    ...
    public:
      ...
      /**
         ...
         */
      ClusterAssociation(const pandora::Cluster* const pVertexCluster,
    ...
    private:
      ...
      float
        m_boundedFraction; ///< The fraction of daughter hits bounded by the cone defined by the vertex cluster
      bool
        m_isConsistentDirection; ///< Whether the vertex and daughter clusters have consistent directions
    };
    ...
    public:
      /**
         ...
         */
      PfoAssociation(const pandora::Pfo* const pVertexPfo,
    ...
    private:
      ...
      const pandora::Pfo*
        m_pDaughterPfo; ///< The address of the non-vertex-associated candidate daughter pfo
    ...
    public:
      /**
         ...
         */
      ConeParameters(const pandora::Cluster* const pCluster,
      ...
      /**
         ...
         *  @return the bounded fraction
         */
      float GetBoundedFraction(const pandora::Cluster* const pDaughterCluster,
     ...
     *  @return boolean
     */
    virtual bool IsVertexAssociated(const pandora::CartesianVector& vertex2D,
     ...
     */
    virtual PfoAssociation GetPfoAssociation(
     ...
     */
    void GetInputPfos(const pandora::Vertex* const pVertex,
                      pandora::PfoList& vertexPfos,
                      pandora::PfoList& nonVertexPfos) const;
     ...
     *  @return boolean
     */
    bool IsVertexAssociated(const pandora::Pfo* const pPfo,
     ...
     */
    void GetPfoAssociations(const pandora::Vertex* const pVertex,
     ...
     *  @return the pfo association details
     */
    PfoAssociation GetPfoAssociation(const pandora::Vertex* const pVertex,
                                     const pandora::Pfo* const pVertexPfo,
                                     const pandora::Pfo* const pDaughterPfo) const;
     ...
     */
    ClusterAssociation GetClusterAssociation(const pandora::Vertex* const pVertex,
    ...
    unsigned int
      m_minVertexAssociatedHitTypes; ///< The min number of vertex associated hit types for a vertex associated pfo

    float
      m_coneAngleCentile; ///< Cluster cone angle is defined using specified centile of distribution of hit half angles
    float m_maxConeCosHalfAngle; ///< Maximum value for cosine of cone half angle
    float
      m_maxConeLengthMultiplier; ///< Consider hits as bound if inside cone, with projected distance less than N times cone length
    ...
    float
      m_meanBoundedFractionCut; ///< Cut on association info (mean bounded fraction) for determining pfo merges
    float
      m_maxBoundedFractionCut; ///< Cut on association info (max bounded fraction) for determining pfo merges
    float
      m_minBoundedFractionCut; ///< Cut on association info (min bounded fraction) for determining pfo merges

    unsigned int
      m_minConsistentDirections; ///< The minimum number of consistent cluster directions to allow a pfo merge
    unsigned int
      m_minConsistentDirectionsTrack; ///< The minimum number of consistent cluster directions to allow a merge involving a track pfo
  };

  //------------------------------------------------------------------------------------------------------------------------------------------

  inline const pandora::Cluster*
  VertexBasedPfoMopUpAlgorithm::ClusterAssociation::GetVertexCluster() const
  {
  ...
  inline const pandora::Cluster*
  VertexBasedPfoMopUpAlgorithm::ClusterAssociation::GetDaughterCluster() const
  {
  ...
  inline const VertexBasedPfoMopUpAlgorithm::ClusterAssociation&
  VertexBasedPfoMopUpAlgorithm::PfoAssociation::GetClusterAssociationU() const
  {
  ...
  inline const VertexBasedPfoMopUpAlgorithm::ClusterAssociation&
  VertexBasedPfoMopUpAlgorithm::PfoAssociation::GetClusterAssociationV() const
  {
  ...
  inline const VertexBasedPfoMopUpAlgorithm::ClusterAssociation&
  VertexBasedPfoMopUpAlgorithm::PfoAssociation::GetClusterAssociationW() const
  {
