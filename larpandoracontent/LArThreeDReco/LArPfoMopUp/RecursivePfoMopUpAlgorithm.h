 ...
 */
  ...
  private:
    ...
    public:
      ...
      const ClusterNumHitsList
        m_numClusterHits;       ///< Vector filled with number of hits in each of the PFO's clusters
  ...
  inline RecursivePfoMopUpAlgorithm::PfoMergeStats::PfoMergeStats(
    const ClusterNumHitsList& numClusterHits,
  ...
  inline bool RecursivePfoMopUpAlgorithm::PfoMergeStatsComp(
    const RecursivePfoMopUpAlgorithm::PfoMergeStats& lhs,
    const RecursivePfoMopUpAlgorithm::PfoMergeStats& rhs)
  {
    return (
      (lhs.m_numClusterHits == rhs.m_numClusterHits) &&
