 ...
 */
  ...
  private:
     ...
     */
    void GetDaughterPfos(const pandora::PfoList* const pfoList,
     ...
     */
    void BuildPointingClusterMap(const pandora::PfoVector& pfoVector,
     ...
     */
    void BuildDaughterParticles(const LArPointingClusterMap& pointingClusterMap,
                                const pandora::PfoVector& pfoVector) const;
     ...
     */
    void BuildDaughterTrack(const LArPointingClusterMap& pointingClusterMap,
                            const pandora::ParticleFlowObject* const pDaughterPfo) const;
     ...
     *  @param  pPfo the input Pfo
     */
    void SetParticleParameters(const pandora::CartesianVector& vtxPosition,
