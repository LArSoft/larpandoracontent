 ...
 */
  ...
  public:
    ...
    public:
      /**
         ...
         */
      PfoInfo(const pandora::ParticleFlowObject* const pPfo,
    ...
    private:
      ...
      bool
        m_isInnerLayerAssociated; ///< If associated, whether association to parent (vtx or pfo) is at sliding fit inner layer
     ...
     */
    void SeparatePfos(const NeutrinoHierarchyAlgorithm::PfoInfoMap& pfoInfoMap,
                      pandora::PfoVector& assignedPfos,
                      pandora::PfoVector& unassignedPfos) const;
  ...
  private:
     ...
     */
    void ProcessPfoInfoMap(const pandora::ParticleFlowObject* const pNeutrinoPfo,
                           const pandora::PfoList& candidateDaughterPfoList,
                           PfoInfoMap& pfoInfoMap,
                           const unsigned int callDepth = 0) const;
     ...
     *  @param  pfoInfoMap the pfo info map
     */
    void AdjustVertexAndPfoInfo(const pandora::ParticleFlowObject* const pNeutrinoPfo,
                                const pandora::PfoList& candidateDaughterPfoList,
     ...
     *  @param  pfoInfoMap the pfo info map
     */
    void DisplayPfoInfoMap(const pandora::ParticleFlowObject* const pNeutrinoPfo,
    ...
    std::string
      m_neutrinoVertexListName; ///< The neutrino vertex list name - if not specified will assume current list
 ...
 */
  ...
  public:
     ...
     */
    virtual void Run(const NeutrinoHierarchyAlgorithm* const pAlgorithm,
  ...
  inline const ThreeDSlidingFitResult* NeutrinoHierarchyAlgorithm::PfoInfo::GetSlidingFitResult3D()
    const
  {
  ...
  inline const pandora::ParticleFlowObject* NeutrinoHierarchyAlgorithm::PfoInfo::GetParentPfo()
    const
  {
    return m_pParentPfo;
  }
