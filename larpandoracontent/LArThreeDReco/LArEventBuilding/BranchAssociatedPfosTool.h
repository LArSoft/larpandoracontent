 ...
 */
  ...
  private:
    ...
    float
      m_minNeutrinoVertexDistance; ///< Branch association: min distance from branch vertex to neutrino vertex
    float
      m_trackBranchAdditionFraction; ///< Branch association: min fraction of length along parent track before association allowed
    float
      m_maxParentClusterDistance; ///< Branch association: max distance from branch vertex to a hit in parent 3D cluster
  };
