  ...
  private:
    ...
    public:
      /**
         ...
         */
      Particle(const pandora::Cluster* const pClusterU,
     ...
     */
    pandora::StatusCode GetAvailableClusters(const pandora::StringVector inputClusterListName,
     ...
     */
    void SelectVertexClusters(const pandora::Vertex* const pVertex,
     ...
     */
    void MatchThreeViews(const pandora::Vertex* const pVertex,
                         const TwoDSlidingFitResultMap& slidingFitResultMap,
     ...
     *  @param  particleList  the output list of matched clusters
     */
    void MatchTwoViews(const pandora::Vertex* const pVertex,
                       const TwoDSlidingFitResultMap& slidingFitResultMap,
                       const pandora::ClusterVector& selectedClusters,
                       pandora::ClusterSet& vetoList,
                       ParticleList& particleList) const;
     ...
     */
    void GetBestChi2(const pandora::Vertex* const pVertex,
                     const TwoDSlidingFitResultMap& slidingFitResultMap,
     ...
     */
    float GetChi2(const pandora::Vertex* const pVertex,
     ...
     */
    void SelectAvailableClusters(const pandora::ClusterSet& vetoList,
     ...
     *  @param  outputVector  the output vector of clusters
     */
    void SelectClusters(const pandora::HitType hitType,
                        const pandora::ClusterVector& inputVector,
                        pandora::ClusterVector& outputVector) const;
     ...
     */
    const LArPointingCluster::Vertex& GetInnerVertex(const pandora::CartesianVector& vertex,
     ...
     */
    const LArPointingCluster::Vertex& GetOuterVertex(const pandora::CartesianVector& vertex,
                                                     const LArPointingCluster& cluster) const;
