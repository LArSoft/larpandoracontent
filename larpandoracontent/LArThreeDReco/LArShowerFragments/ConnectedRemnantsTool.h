 ...
 */
  ...
  private:
     ...
     */
    void FindConnectedShowers(const TensorType& overlapTensor,
     ...
     */
    void FillMergeMap(const pandora::Cluster* const pCluster,
