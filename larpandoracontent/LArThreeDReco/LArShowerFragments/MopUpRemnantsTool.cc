...
namespace lar_content {
  ...
  bool MopUpRemnantsTool::Run(ThreeViewRemnantsAlgorithm* const pAlgorithm,
  ...
  void MopUpRemnantsTool::FindBestShowers(const TensorType& overlapTensor,
                                          ProtoParticleVector& protoParticleVector) const
  {
    ...
    for (const Cluster* const pKeyCluster : sortedKeyClusters) {
      ...
      if (connectedElements.end() == eIter) continue;
  ...
  void MopUpRemnantsTool::GetUsedClusters(const TensorType::ElementList& elementList,
  ...
  void MopUpRemnantsTool::SelectBestElement(const TensorType::ElementList& elementList,
                                            ...
                                            TensorType::ElementList::const_iterator& bestIter) const
  {
    ...
    for (TensorType::ElementList::const_iterator eIter = elementList.begin();
      ...
      const float figureOfMerit(pClusterU->GetHadronicEnergy() + pClusterV->GetHadronicEnergy() +
                                pClusterW->GetHadronicEnergy());
