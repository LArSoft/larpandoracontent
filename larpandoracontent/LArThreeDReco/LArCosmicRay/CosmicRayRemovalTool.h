 ...
 */
  ...
  private:
     ...
     */
    void CreateSeed(const TensorType::Element& element,
     ...
     */
    pandora::StatusCode GrowSeed(const TensorType::Element& element,
                                 const pandora::HitType hitType,
     ...
     *  @param  deltaRayRemantHits the list of remainder hits
     */
    void SplitDeltaRayCluster(const TensorType::Element& element,
                              const pandora::HitType hitType,
                              pandora::CaloHitList& collectedHits,
