 ...
 */
  ...
  private:
     ...
     */
    bool AddIntoExistingDeltaRay(const pandora::Cluster* const pAvailableCluster,
     ...
     */
    const pandora::Cluster* GetBestProjectedCluster(
      const pandora::ClusterList& deltaRayClusterGroup,
     ...
     */
    void CreateDeltaRay(const pandora::Cluster* const pAvailableCluster,
                        const pandora::PfoVector& nearbyMuonPfoVector,
     ...
     */
    void GetNearbyAvailableClusters(const pandora::Cluster* const pCluster,
     ...
     */
    void CreatePfo(const pandora::Cluster* const pCluster1,
    ...
    float
      m_overlapExtension; ///< The extension to each side of the x overlap region in which to search for matched clusters
