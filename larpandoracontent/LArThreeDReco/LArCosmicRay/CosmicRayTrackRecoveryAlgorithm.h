 ...
 */
  ...
  private:
     ...
     */
    void SelectCleanClusters(const pandora::ClusterVector& inputVector,
     ...
     */
    void MatchViews(const pandora::ClusterVector& clusterVector1,
     ...
     *  @param clusterAssociationMap the output map of cluster associations
     */
    void MatchClusters(const pandora::Cluster* const pSeedCluster,
     ...
     */
    void MatchThreeViews(const pandora::ClusterVector& clusterVectorU,
     ...
     */
    void RemoveAmbiguities(const ParticleList& inputParticleList,
     ...
     */
    void MergeClusters(const pandora::ClusterList& inputClusterList,
                       pandora::ClusterList& outputClusterList) const;
