 ...
 */
  ...
  protected:
     ...
     */
    bool IsMuonEndpoint(const TensorType::Element& element,
     ...
     */
    bool IsBestElement(const TensorType::Element& element,
     ...
     */
    void FindExtrapolatedHits(const pandora::Cluster* const pCluster,
    ...
    float
      m_minSeparation; ///< The minimum delta ray - parent muon cluster separation required to investigate a delta/cosmic ray cluster
    float
