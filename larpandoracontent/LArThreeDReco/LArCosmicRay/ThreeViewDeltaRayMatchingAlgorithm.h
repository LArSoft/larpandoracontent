 ...
 */
  class ThreeViewDeltaRayMatchingAlgorithm
    : public NViewDeltaRayMatchingAlgorithm<ThreeViewMatchingControl<DeltaRayOverlapResult>> {
  public:
    typedef NViewDeltaRayMatchingAlgorithm<ThreeViewMatchingControl<DeltaRayOverlapResult>>
      BaseAlgorithm;
  ...
  private:
     ...
     */
    void FindCommonMuonParents(const pandora::Cluster* const pClusterU,
                               const pandora::Cluster* const pClusterV,
                               const pandora::Cluster* const pClusterW,
 ...
 */
  ...
  public:
     ...
     */
    virtual bool Run(ThreeViewDeltaRayMatchingAlgorithm* const pAlgorithm,
