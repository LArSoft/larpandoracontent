 ...
 */
  ...
  protected:
     ...
     */
    virtual void SelectCleanClusters(const pandora::ClusterVector& inputVector,
                                     pandora::ClusterVector& outputVector) const = 0;
     ...
     *  @return boolean
     */
    virtual bool MatchClusters(const pandora::Cluster* const pCluster1,
                               const pandora::Cluster* const pCluster2) const = 0;
     ...
     *  @return boolean
     */
    virtual bool CheckMatchedClusters3D(const pandora::Cluster* const pCluster1,
    ...
    virtual void SetPfoParameters(
      const CosmicRayBaseMatchingAlgorithm::Particle& protoParticle,
  ...
  private:
     ...
     */
    pandora::StatusCode GetAvailableClusters(const std::string inputClusterListName,
     ...
     */
    void MatchClusters(
      const pandora::ClusterVector& clusterVector1,
    ...
    void MatchThreeViews(
      const CosmicRayBaseMatchingAlgorithm::ClusterAssociationMap& matchedClusters12,
