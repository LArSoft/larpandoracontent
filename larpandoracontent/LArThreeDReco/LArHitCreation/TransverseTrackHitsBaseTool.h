 ...
 */
  ...
  protected:
     ...
     */
    virtual void GetTransverseTrackHit3D(const MatchedSlidingFitMap& matchedSlidingFitMap,
     ...
     */
    virtual void AddTransverseChi2(const MatchedSlidingFitMap& matchedSlidingFitMap,
  ...
  private:
     ...
     */
    double GetTransverseChi2(const pandora::CartesianVector& position2D,
