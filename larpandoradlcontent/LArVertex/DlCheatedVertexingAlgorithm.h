/**
 *  @file   larpandoradlcontent/LArVertexing/DlCheatedVertexingAlgorithm.h
 *
 *  @brief  Header file for the deep learning vertexing algorithm.
 *
 *  $Log: $
 */
#ifndef LAR_DL_CHEATED_VERTEXING_ALGORITHM_H
#define LAR_DL_CHEATED_VERTEXING_ALGORITHM_H 1
 ...
 */
class DlCheatedVertexingAlgorithm : public pandora::Algorithm
{
public:
     ...
     */
    DlCheatedVertexingAlgorithm();

    virtual ~DlCheatedVertexingAlgorithm();
...
#endif // LAR_DL_CHEATED_VERTEXING_ALGORITHM_H
